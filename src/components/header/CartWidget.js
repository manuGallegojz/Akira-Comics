...
export default function CartWidget(){
    ...
    return(
            ...
            <NavLink to="/Akira-Comics/carrito" className="nav-link text-dark d-flex">
                    <div className='me-3'>
            ...
            {visibleDesplegable && <div className='border bg-white posicionDesplegable container pb-3 mt-3' onMouseLeave={() => setVisibleDesplegable(false)}>
